        ...
        <div class="row align-items-end">
            ...
            <div class="col-sm-auto">
                <a class="btn btn-primary" href="{{ route('dashboard.roles.create') }}">
                    <i class="bi-person-plus-fill me-1"></i> Add Roles
                </a>
            </div>
            <!-- End Col -->
        </div>
        ...
        <div class="table-responsive datatable-custom">
            <table id="exportDatatable"
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <a class="d-flex align-items-center" href="{{ route('dashboard.roles.show', $role->id) }}">
                                <div class="ms-3">
                        ...
                        <td>
                            <div class="hs-unfold">
                                ...
                                <div class="dropdown-menu dropdown-menu-end mt-1" aria-labelledby="settingsDropdown1">
                                    ...
                                    <a class="dropdown-item" href="{{ route('dashboard.roles.show', $role->id) }}">
                                        Show
                                    </a>
