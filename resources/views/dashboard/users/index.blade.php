                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            ...
                            <a class="d-flex align-items-center" href="{{ route('dashboard.users.show', $user->id) }}">
                                <div class="avatar">
                        ...
                        <td>
                            <span class="legend-indicator "></span>Status
                        </td>
                        <td>
                            ...
                            <div class="hs-unfold">
                                ...
                                <div class="dropdown-menu dropdown-menu-end mt-1" aria-labelledby="settingsDropdown1">
                                    ...
                                    {{-- <a class="dropdown-item"
                                        ...
                                        <i class="bi-diagram-3 dropdown-item-icon"></i> Roles
                                    </a> --}}
